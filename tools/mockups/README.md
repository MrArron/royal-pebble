...
Scripts that made the §8 daily view drafts in `docs/mockups/phase2-draft/`
...
python tools/mockups/check_fit.py "docs/mockups/phase2-draft/*.dc.html" <scratch folder>
```
